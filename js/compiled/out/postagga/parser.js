...
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.get.call(null,input_item,(1))], true),current_tag_alternatives);
});
/**
...
if(cljs.core.contains_QMARK_.call(null,current_tag_alternatives,new cljs.core.Keyword(null,"multi","multi",-190293005))){
if((cljs.core.second.call(null,tag_stack) instanceof cljs.core.Keyword)){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"step","step",1288888124),cljs.core.second.call(null,tag_stack),new cljs.core.Keyword(null,"new-stack","new-stack",1596588953),cljs.core.rest.call(null,tag_stack)], null);
} else {
...
var G__46114 = cljs.core.rest.call(null,tag_stack);
tag_stack = G__46114;
continue;
}
} else {
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [item,cljs.core.PersistentHashSet.createAsIfByAssoc([postag], true)], null);
...
var map__46117 = postagga.parser.accept_tag.call(null,input_item,tag_stack);
...
var accept_QMARK_ = map__46117__$1;
var step = cljs.core.get.call(null,map__46117__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var new_stack = cljs.core.get.call(null,map__46117__$1,new cljs.core.Keyword(null,"new-stack","new-stack",1596588953));
if(cljs.core.truth_(step)){
var G__46119 = input_items;
var G__46120 = new_stack;
var G__46121 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"step","step",1288888124),step,new cljs.core.Keyword(null,"items","items",1031954938),cljs.core.PersistentVector.EMPTY], null);
var G__46122 = ((cljs.core.empty_QMARK_.call(null,cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"items","items",1031954938))))?output:cljs.core.assoc.call(null,output,cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"step","step",1288888124)),cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"items","items",1031954938))));
input_items = G__46119;
tag_stack = G__46120;
output_stack = G__46121;
output = G__46122;
continue;
} else {
if(cljs.core.truth_((function (){var and__44814__auto__ = cljs.core.not.call(null,accept_QMARK_);
if(and__44814__auto__){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.get.call(null,output_stack,new cljs.core.Keyword(null,"step","step",1288888124))], true),optional_steps);
} else {
...
var G__46123 = input_items;
var G__46124 = ffw_stack;
var G__46125 = output_stack;
var G__46126 = output;
input_items = G__46123;
tag_stack = G__46124;
output_stack = G__46125;
output = G__46126;
continue;
} else {
...
if(cljs.core.truth_((function (){var or__44826__auto__ = (cljs.core.empty_QMARK_.call(null,input_items)) && (cljs.core.empty_QMARK_.call(null,tag_stack));
if(or__44826__auto__){
return or__44826__auto__;
} else {
var or__44826__auto____$1 = cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.first.call(null,tag_stack)], true),optional_steps);
...
var G__46131 = cljs.core.rest.call(null,rem_rules);
var G__46132 = cljs.core.conj.call(null,errors,err);
rem_rules = G__46131;
errors = G__46132;
continue;
} else {
...
//# sourceMappingURL=parser.js.map?rel=1491522834809