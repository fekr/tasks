...
var G__45574 = cljs.core.rest.call(null,remaining_chars);
var G__45575 = cljs.core.update_in.call(null,result,path_in_node,((function (remaining_chars,result,path,path_in_node,str_seq){
return (function (p1__45573_SHARP_){
return cljs.core.merge_with.call(null,cljs.core._PLUS_,p1__45573_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"nb","nb",1313629270),(1)], null));
});})(remaining_chars,result,path,path_in_node,str_seq))
);
var G__45576 = cljs.core.conj.call(null,path_in_node,new cljs.core.Keyword(null,"next","next",-117701485));
remaining_chars = G__45574;
result = G__45575;
path = G__45576;
continue;
} else {
...
var G__45581 = cljs.core.get_in.call(null,common_branch,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [c_key,new cljs.core.Keyword(null,"next","next",-117701485)], null));
var G__45582 = cljs.core.conj.call(null,r_commons,c_key);
common_branch = G__45581;
r_commons = G__45582;
continue;
}
}
...
return (function (p1__45580_SHARP_){
return [cljs.core.str(the_string),cljs.core.str(str_commons),cljs.core.str(cljs.core.get.call(null,p1__45580_SHARP_,new cljs.core.Keyword(null,"result","result",1415092211)))].join('');
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str(the_string),cljs.core.str(str_commons)].join('')], null);
} else {
return null;
}
}
...
var G__45583 = cljs.core.rest.call(null,rentities);
var G__45584 = postagga.trie.insert_str_in_trie.call(null,result,cljs.core.first.call(null,rentities));
rentities = G__45583;
result = G__45584;
continue;
} else {
...
//# sourceMappingURL=trie.js.map?rel=1491402063210